                ...
                <div className='main-slider-container'>
                    ...
                    <div className='form-in-content'>
                        <div className='form'>
                            ...
                            <p className='font-18px'>consectetur adipiscing elit. Ut auctor arcu </p>
                            <p className='font-18px font-bold'>Zostaw kontakt, zadzwonimy do Ciebie</p>
                            ...
                            <div className='agreement'>
                                ...
                                <div> Wyrażam dobrowolną zgodę na przetwarzanie moich danych osobowych więcej...</div>
                                
                            </div>                           
                            <input className='button-send-form' type='text' value='Wyślij'></input>
                        </div>
                    </div>
                                      
                </div>
                <div className='button-slider-container'>
                    <input id='button-slider-prev' type='image' src={arrowBack} onClick={() =>prev()}></input>
                    <input id='button-slider-next' type='image' src={arrowNext} onClick={() =>next()}></input>                    
                </div>               
